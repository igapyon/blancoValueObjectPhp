 ...
 */
/*. DOC <@package careco.sample.valueobject;>.*/
...
class Carecosystem {
    ...
    public /*.void.*/ function setStringField1(/*.string.*/ $argStringField1) {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 1) {
            throw new Exception('[ArgumentException]: Carecosystem.setStringField1 のパラメータは[1]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
        if (gettype($argStringField1) !== 'string' && gettype($argStringField1) !== 'NULL') {
            throw new Exception('[ArgumentException]: Carecosystem.setStringField1 の1番目のパラメータは[string]型でなくてはなりません。しかし実際には[' . gettype($argStringField1) . ']型が与えられました。');
        }
    ...
    public /*.string.*/ function getStringField1() {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 0) {
            throw new Exception('[ArgumentException]: Carecosystem.getStringField1 のパラメータは[0]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
    ...
    public /*.void.*/ function setStringField2(/*.string.*/ $argStringField2) {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 1) {
            throw new Exception('[ArgumentException]: Carecosystem.setStringField2 のパラメータは[1]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
        if (gettype($argStringField2) !== 'string' && gettype($argStringField2) !== 'NULL') {
            throw new Exception('[ArgumentException]: Carecosystem.setStringField2 の1番目のパラメータは[string]型でなくてはなりません。しかし実際には[' . gettype($argStringField2) . ']型が与えられました。');
        }
    ...
    public /*.string.*/ function getStringField2() {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 0) {
            throw new Exception('[ArgumentException]: Carecosystem.getStringField2 のパラメータは[0]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
    ...
    public /*.void.*/ function setBooleanField1(/*.boolean.*/ $argBooleanField1) {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 1) {
            throw new Exception('[ArgumentException]: Carecosystem.setBooleanField1 のパラメータは[1]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
        if (gettype($argBooleanField1) !== 'boolean' && gettype($argBooleanField1) !== 'NULL') {
            throw new Exception('[ArgumentException]: Carecosystem.setBooleanField1 の1番目のパラメータは[boolean]型でなくてはなりません。しかし実際には[' . gettype($argBooleanField1) . ']型が与えられました。');
        }
    ...
    public /*.boolean.*/ function getBooleanField1() {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 0) {
            throw new Exception('[ArgumentException]: Carecosystem.getBooleanField1 のパラメータは[0]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
    ...
    public /*.void.*/ function setBooleanField2(/*.boolean.*/ $argBooleanField2) {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 1) {
            throw new Exception('[ArgumentException]: Carecosystem.setBooleanField2 のパラメータは[1]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
        if (gettype($argBooleanField2) !== 'boolean' && gettype($argBooleanField2) !== 'NULL') {
            throw new Exception('[ArgumentException]: Carecosystem.setBooleanField2 の1番目のパラメータは[boolean]型でなくてはなりません。しかし実際には[' . gettype($argBooleanField2) . ']型が与えられました。');
        }
    ...
    public /*.boolean.*/ function getBooleanField2() {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 0) {
            throw new Exception('[ArgumentException]: Carecosystem.getBooleanField2 のパラメータは[0]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
    ...
    public /*.void.*/ function setIntField1(/*.int.*/ $argIntField1) {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 1) {
            throw new Exception('[ArgumentException]: Carecosystem.setIntField1 のパラメータは[1]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
        if (gettype($argIntField1) !== 'integer' && gettype($argIntField1) !== 'NULL') {
            throw new Exception('[ArgumentException]: Carecosystem.setIntField1 の1番目のパラメータは[integer]型でなくてはなりません。しかし実際には[' . gettype($argIntField1) . ']型が与えられました。');
        }
    ...
    public /*.int.*/ function getIntField1() {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 0) {
            throw new Exception('[ArgumentException]: Carecosystem.getIntField1 のパラメータは[0]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
    ...
    public /*.void.*/ function setIntField2(/*.int.*/ $argIntField2) {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 1) {
            throw new Exception('[ArgumentException]: Carecosystem.setIntField2 のパラメータは[1]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
        if (gettype($argIntField2) !== 'integer' && gettype($argIntField2) !== 'NULL') {
            throw new Exception('[ArgumentException]: Carecosystem.setIntField2 の1番目のパラメータは[integer]型でなくてはなりません。しかし実際には[' . gettype($argIntField2) . ']型が与えられました。');
        }
    ...
    public /*.int.*/ function getIntField2() {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 0) {
            throw new Exception('[ArgumentException]: Carecosystem.getIntField2 のパラメータは[0]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
    ...
    public /*.void.*/ function setFloatField1(/*.float.*/ $argFloatField1) {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 1) {
            throw new Exception('[ArgumentException]: Carecosystem.setFloatField1 のパラメータは[1]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
        if (gettype($argFloatField1) !== 'double' && gettype($argFloatField1) !== 'NULL') {
            throw new Exception('[ArgumentException]: Carecosystem.setFloatField1 の1番目のパラメータは[float]型でなくてはなりません。しかし実際には[' . gettype($argFloatField1) . ']型が与えられました。');
        }
    ...
    public /*.float.*/ function getFloatField1() {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 0) {
            throw new Exception('[ArgumentException]: Carecosystem.getFloatField1 のパラメータは[0]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
    ...
    public /*.void.*/ function setFloatField2(/*.float.*/ $argFloatField2) {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 1) {
            throw new Exception('[ArgumentException]: Carecosystem.setFloatField2 のパラメータは[1]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
        if (gettype($argFloatField2) !== 'double' && gettype($argFloatField2) !== 'NULL') {
            throw new Exception('[ArgumentException]: Carecosystem.setFloatField2 の1番目のパラメータは[float]型でなくてはなりません。しかし実際には[' . gettype($argFloatField2) . ']型が与えられました。');
        }
    ...
    public /*.float.*/ function getFloatField2() {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 0) {
            throw new Exception('[ArgumentException]: Carecosystem.getFloatField2 のパラメータは[0]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
    ...
    public /*.void.*/ function setDoubleField1(/*.float.*/ $argDoubleField1) {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 1) {
            throw new Exception('[ArgumentException]: Carecosystem.setDoubleField1 のパラメータは[1]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
        if (gettype($argDoubleField1) !== 'double' && gettype($argDoubleField1) !== 'NULL') {
            throw new Exception('[ArgumentException]: Carecosystem.setDoubleField1 の1番目のパラメータは[double]型でなくてはなりません。しかし実際には[' . gettype($argDoubleField1) . ']型が与えられました。');
        }
    ...
    public /*.float.*/ function getDoubleField1() {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 0) {
            throw new Exception('[ArgumentException]: Carecosystem.getDoubleField1 のパラメータは[0]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
    ...
    public /*.void.*/ function setDoubleField2(/*.float.*/ $argDoubleField2) {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 1) {
            throw new Exception('[ArgumentException]: Carecosystem.setDoubleField2 のパラメータは[1]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
        if (gettype($argDoubleField2) !== 'double' && gettype($argDoubleField2) !== 'NULL') {
            throw new Exception('[ArgumentException]: Carecosystem.setDoubleField2 の1番目のパラメータは[double]型でなくてはなりません。しかし実際には[' . gettype($argDoubleField2) . ']型が与えられました。');
        }
    ...
    public /*.float.*/ function getDoubleField2() {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 0) {
            throw new Exception('[ArgumentException]: Carecosystem.getDoubleField2 のパラメータは[0]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }
    ...
    public /*.string.*/ function __toString() {
        /* パラメータの数、型チェックを行います。 */
        if (func_num_args() !== 0) {
            throw new Exception('[ArgumentException]: Carecosystem.__toString のパラメータは[0]個である必要があります。しかし実際には[' . func_num_args() .  ']個のパラメータを伴って呼び出されました。');
        }

        $buf = '';
        $buf = $buf . 'careco.sample.valueobject.Carecosystem[';
