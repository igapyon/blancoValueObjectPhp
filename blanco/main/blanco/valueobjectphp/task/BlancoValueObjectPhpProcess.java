...
/**
 * 処理 [BlancoValueObjectPhpProcess]インタフェース。
 *
 * このインタフェースを継承して [blanco.valueobjectphp.task]パッケージに[BlancoValueObjectPhpProcess]クラスを作成して実際のバッチ処理を実装してください。<br>
 */
interface BlancoValueObjectPhpProcess {
     ...
     */
    int execute(final BlancoValueObjectPhpProcessInput input) throws IOException, IllegalArgumentException;
